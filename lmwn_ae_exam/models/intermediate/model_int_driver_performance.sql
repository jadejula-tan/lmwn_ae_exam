WITH driver_performance_aggregated AS(
    SELECT
        ...
        COUNT(DISTINCT CASE WHEN order_status = 'completed' THEN order_id END) AS total_completed_tasks,
        COUNT(DISTINCT CASE WHEN order_status = 'completed' AND is_late_delivery THEN order_id END) AS late_completed_tasks,
